 ...
 *
 * This code runs entirely in the learner's browser. The backend never
 * sees the code before it runs and never executes it — only the
 * resulting stdout/stderr/result gets POSTed to the coding-sandbox API
 * afterwards, by CodeMissionRunner.
 */
...
/**
 * Worker source, built as a Blob URL at runtime so this stays a single
 * importable module (no separate .worker.ts build step required).
 */
